<template>
  <div class="app-container">
    <div class="filter-container">
      <el-input v-model="listQuery.title" placeholder="查询课程信息" style="width: 200px;" class="filter-item"
    ...
    <el-table
      ...
      :data="this.$store.state.lab5CourseSelection"
      border
      fit
...
<!--            <el-table-column v-for="(value,key,index) in this.$store.state.lab5CourseSelection[0]"-->
<!--                             :prop="key"-->
<!--                             :label="key"-->
<!--            ></el-table-column>-->
      <el-table-column
      ...
      <el-table-column label="操作" align="center" width="230" class-name="small-padding fixed-width">
        <template slot-scope="scope">
          <el-button type="primary" size="mini" @click="handleSelect(scope.$index)" :disabled="scope.row.selected">
            选课
          </el-button>
          <el-button  size="mini" type="danger" @click="handleUnSelect(scope.$index)" :disabled="!scope.  row.selected">
            退选
          </el-button>
        </template>
      </el-table-column>
    ...
    <pagination v-show="total>0" :total="total" :page.sync="listQuery.page" :limit.sync="listQuery.limit"
                @pagination="getTeacher"/>


    <!--  弹出框  -->
    <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible">
      <el-form ref="dataForm" :model="teacher" label-position="left" label-width="70px"
...
import {getCourseSelection} from "@/api/lab5";
...
export default {
  ...
  methods: {
    ...
    handleSelect(index) {
      console.log("当前选课index为",index)
      this.$store.state.lab5CourseSelection[index]['selected'] = true
    },
    handleUnSelect(index) {
      console.log("当前退选index为",index)
      this.$store.state.lab5CourseSelection[index]['selected'] = false
    },
